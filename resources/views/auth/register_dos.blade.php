            ...
            <div class="col-xl-5 p-0">
                <div class="login-card">
                    <div class="login-main col-10 col-md-10">
                        <form method="POST" action={{route('register_dosen')}} class="theme-form">
                            @csrf
                            <h1>🎓</h1>
                            <h4>Daftarkan akun Anda sekarang</h4>
                            <p class="mb-2">Masukan data yang diperlukan untuk membuat akun dosen</p>
                            ...
                            <div class="input-group mb-3">
								...
								<input type="radio" id="html" name="status" value="Internal">
								<label for="html">Internal</label><br>
								<input type="radio" id="css" name="status" value="luar_unidha">
								<label for="css">Luar Unidha</label><br>
                               
                            </div-->
							
							<label class="col-form-label pt-0">NIDN/NUPN/NIK</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <input class="form-control" type="text" name="nip" placeholder="Masukkan NIK anda disini"
                                    required autofocus>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Masukkan nama anda disini"
                                    required autofocus>
                            </div>
							
							<label class="col-form-label pt-0">Fakultas</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
