                ...
                <div class="login-card">
                    <div class="login-main col-10 col-md-10">
                        <form method="POST" action={{route('register')}} class="theme-form">
							...
							<label class="col-form-label pt-0">Status Mahasiswa</label>
                            <div class="input-group mb-3">
                                ...
                                <input type="radio" class="ml-3" id="html" name="status" value="internal" required {{ (old('status') ?? NULL) == 'internal' ? 'checked' : '' }}>
                                <label for="html" class="ml-3">Internal</label><br>
                                <input type="radio" class="ml-3" id="css" name="status" value="luar_unidha" {{ (old('status') ?? NULL) == 'luar_unidha' ? 'checked' : '' }}>
                                <label for="css" class="ml-3">Luar Unidha</label><br>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="text" name="nim" placeholder="Masukkan NIM mu disini" required autofocus value="{{ old('nim') ?? '' }}">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Masukkan namamu disini" required value="{{ old('name') ?? '' }}">
                            </div>
							
							<label class="col-form-label pt-0">Tahun Ajaran / Semester</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <!--input class="form-control" type="text" name="tahun_ajaran" placeholder="2022"
                                    required autofocus-->
								<select class="form-control" id="tahun_ajaran" name="tahun_ajaran">
								   @foreach ($t_a as $ta)
									  <option value="{{ $ta->id }}">{{ $ta->tahun_ajaran . ' - ' . $ta->semester->nama }}</option>
								   @endforeach
								</select>	
                            </div>							
							
							<label class="col-form-label pt-0">Program</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
								...
								<select class="form-control" id="program-option" name="program">
                            ...
                            <div class="input-group mb-3">
								...
								<select class="form-control" id="kelas-option" name="kelas_id">
							...
							<label class="col-form-label pt-0">Nama Mitra</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
								...
								<input class="form-control" type="text" name="mitra" placeholder="" required value="{{ old('mitra') ?? '' }}">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="email" name="email" placeholder="contoh@gmail.com" required value="{{ old('email') ?? '' }}">
                            </div>
