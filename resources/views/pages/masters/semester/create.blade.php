...
<x-cards.regular-card heading="Insert New Data">
    <form action="{{ route('semester.store') }}" method="post" autocomplete="off">
        @csrf
        @method('POST')
        <div class="d-flex flex-row">
            <x-inputs.textfield class="flex-grow-1 mr-3" label="Nama Mitra" name="nama" placeholder="Nama Semester" />
        </div>
        <div class="d-flex flex-row">
