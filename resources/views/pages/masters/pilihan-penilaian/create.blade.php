...
@section('title', 'New Pilihan Penilaian')
@section('content')
...
<x-cards.regular-card heading="Insert New Pilihan Penilaian">
    <form action="{{ route('penilaian.pilihan_penilaian.store', ['id'=> $penilaian->id]) }}" method="post" autocomplete="off">
        @csrf
        @method('POST')
        ...
        <div class="d-flex flex-row">
            <x-inputs.textfield class="flex-grow-1 mr-3" label="Teks Pilihan" name="isi_pilihan" placeholder="Teks Pilihan" />
        </div>
        <div class="d-flex flex-row">
            <x-inputs.textfield class="flex-grow-1 mr-3" label="Bobot" type="number" name="bobot" min="1" max="10" step="1" placeholder="Bobot" >
