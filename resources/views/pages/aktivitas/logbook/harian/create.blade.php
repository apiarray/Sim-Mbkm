...
@section('title', 'New Logbook Harian')
@section('content')
    ...
    <x-cards.regular-card heading="Insert New Logbook Harian">
        <form action="{{ route('aktivitas.logbook.harian.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
            @csrf
            @method('POST')
