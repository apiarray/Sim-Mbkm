        ...
        <div class="d-flex flex-row">
            <div class="flex-grow-1 mr-3 mb-3">
                ...
                <select name="durasi" id="durasi" class="form-control">
                    <option value="{{ old('durasi') ?? ($dataLogbookHarian->durasi ?? null) }}">{{ old('durasi') ?? ($dataLogbookHarian->durasi ?? null) }} Jam</option>
                    <option value="6" {{ (old('durasi') ?? null) == 6 ? 'selected' : '' }}>6 Jam</option>
                    <option value="8" {{ (old('durasi') ?? null) == 8 ? 'selected' : '' }}>8 Jam</option>
                </select>
                <!-- <x-inputs.textfield class="flex-grow-1 mr-3" label="Durasi" name="durasi" value="{{ old('durasi') ?? ($dataLogbookHarian->durasi ?? null) }}" /> -->
            </div>
        </div>
        <div class="d-flex flex-row">
