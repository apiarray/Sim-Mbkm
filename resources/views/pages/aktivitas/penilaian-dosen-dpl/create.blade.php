...
<x-cards.regular-card heading="Add Penilaian Dosen">
    <form action="{{ route('aktivitas.penilaian_dosen_dpl.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" name="registrasi_mbkm_id" id="id_validasi_registrasi" onchange="getIdRegistrasiData(this);getLogbookHarian(this) ;getLogbookMingguan(this); getLaporanAkhirMahasiswa(this)">
...
<script>
    ...
    function getLogbookHarian(e) {

        let id = $(e).val()
        console.log('logbook harian', id);
        ...
        if (id) {
            ...
            $.ajax({
                url: "{{ url('dashboard/aktivitas/logbook/harian/list-all') }}",
                // accepts: 'application/json',
                type: 'GET',
                data: {
                ...
                success: function(resp) {
                    ...
                    $('#div_logbook_harian').html(htmlTable)
                }
            })
        } else {
            $('#div_logbook_harian').html('')
        }
